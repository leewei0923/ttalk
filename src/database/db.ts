...
class ChatDataBase extends Dexie {
  ...
  constructor(DBName: string) {
    ...
    this.version(10).stores({
      ...
      messageData: `++id,remote_id, [user_account+type],[user_account+remote_id], [user_account+friend_account],[friend_account+type+read_flag], user_account, friend_account, mood_state, type, message_style, message, read_flag, create_time, update_time`
    });
